...
export const dictionary = {
    ...
    modelConfig: {
        ...
        bedrockAuthType: "Authentication",
        bedrockCredentials: "IAM Credentials (AK/SK)",
        bedrockBearerToken: "API Key (Bearer Token)",
        bedrockApiKey: "Bedrock API Key",
        enterBedrockApiKey: "Enter Your Bedrock API Key",
        test: "Test",
        apiKey: "API Key",
